...
Some options in CLI are arrays that mean that you can set multiple urls, schemas, headers, documents...
Tips:
 - Urls and schemas args count should always match.
 - Document params will be added to lists of documents regarding order.
 - By default, typescript client files will be named as schema, to set custom names set corresponding count of --gqlFile arguments
