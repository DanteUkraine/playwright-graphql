...
function expectedPath(expectedUnitPath: string): string {
    if (os.platform() === 'win32') {
        return expectedUnitPath.replace(/\//g, '\\');
    }

    return expectedUnitPath;
}
...
describe('Setup Codegen CLI', () => {
    ...
    test('generates schema and operations from url no headers', async () => {
        ...
        expect(cliLogs).toMatchObject({
            stdout: 'Schema generated from "http://localhost:4000" to "test-schema.gql".\n' +
                    `Operations were generated and saved to "${expectedPath(`${gqlDirectory}/${schemaName}/autogenerated-operations`)}".\n` +
    ...
    test('generates schemas and operations from multiple urls no headers', async () => {
        ...
        expect(cliLogs.stdout.split('\n').filter(i => i).sort()).toMatchObject([
                ...
                `Operations were generated and saved to "${expectedPath(`gql/first-${schemaFile.split('.')[0]}/autogenerated-operations`)}".`,
                `Operations were generated and saved to "${expectedPath(`gql/second-${schemaFile.split('.')[0]}/autogenerated-operations`)}".`,
                'Type Script types for Playwright auto generated type safe GQL client generated.',
        ].sort());
    });
    ...
    test('generates schemas and operations from multiple schemas default gql naming', async () => {
        ...
        expect(cliLogs.stdout.split('\n').filter(i => i).sort()).toMatchObject([
            ...
            `Operations were generated and saved to "${expectedPath('gql/first-schema/autogenerated-operations')}".`,
            `Operations were generated and saved to "${expectedPath('gql/second-schema/autogenerated-operations')}".`,
            'Type Script types for Playwright auto generated type safe GQL client generated.',
        ].sort());
    });
    ...
    test('generates multiple clients when schemas passed as related path', async () => {
        const cliLogs = await execAsync(
            `node ${cliPath} -u ${stabServer} -u ${stabServer} -s ./gql/first-schema.gql -s ./gql/second-schema.gql`,
            { cwd: testDir }
        );
        ...
        // order is not strict since schema introspect works in Promise all
        expect(cliLogs.stdout.split('\n').filter(i => i).sort()).toMatchObject([
            `Schema generated from "http://localhost:4000" to "./gql/first-schema.gql".`,
            `Schema generated from "http://localhost:4000" to "./gql/second-schema.gql".`,
            `Operations were generated and saved to "${expectedPath('gql/first-schema/autogenerated-operations')}".`,
            `Operations were generated and saved to "${expectedPath('gql/second-schema/autogenerated-operations')}".`,
            'Type Script types for Playwright auto generated type safe GQL client generated.',
        ].sort());
    ...
    test('generates schema and operations from url with headers', async () => {
        ...
        expect(cliLogs).toMatchObject({
            stdout: 'Schema generated from "http://localhost:4000" to "test-schema.gql".\n' +
                    `Operations were generated and saved to "${expectedPath(`gql/${schemaName}/autogenerated-operations`)}".\n` +
                    'Type Script types for Playwright auto generated type safe GQL client generated.\n',
        });
    });
    ...
    test('generates types from existing schema and adds coverage logger to client', async () => {
        ...
        expect(cliLogs).toMatchObject({
            stdout: `Operations were generated and saved to "${expectedPath('gql/existing-schema/autogenerated-operations')}".\n` +
                    'Type Script types for Playwright auto generated type safe GQL client generated.\n',
        });
    });
    ...
    test('generate type safe client with --saveCodegen', async () => {
        ...
        expect(cliLogs).toMatchObject({
            stdout: `Schema generated from "${stabServer}" to "schema.gql".\n` +
                `Operations were generated and saved to "${expectedPath(`${gqlDirectory}/schema/autogenerated-operations`)}".\n` +
                `Type Script types for Playwright auto generated type safe GQL client generated.\n` +
                `File "codegen.ts" generated.\n`,
        });
